...
pushd "%ROOTDIR%\tools\"
"%ProgramFiles%\7-Zip\7z.exe" x "%TEMP%\mpv-dev-x86_64-20260123-git-dd50a47.7z" libmpv-2.dll
popd
...
pushd "%ROOTDIR%\tools\"
"%ProgramFiles%\7-Zip\7z.exe" x "%TEMP%\mpv-dev-aarch64-20260123-git-dd50a47.7z" libmpv-2.dll
popd
