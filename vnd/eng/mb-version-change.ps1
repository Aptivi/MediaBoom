...
$oldPackageWxs = "Name=`"MediaBoom $oldVerNoPatch`""
$newPackageWxs = "Name=`"MediaBoom $newVerNoPatch`""
$packageWxsFile = "$rootDir\public\MediaBoom.Installers\MediaBoom.Installer\Package.wxs"
...
$oldPkgNameVcs = "pkgname=mediaboom-$($oldApiVersionSplit[2])"
$newPkgNameVcs = "pkgname=mediaboom-$($newApiVersionSplit[2])"
