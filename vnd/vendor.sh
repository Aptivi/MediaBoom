...
localize() {
    ...
    curl -L --output "$ROOTDIR/vnd/mpv-dev-x86_64-20260107-git-85bf9f4.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-07-85bf9f4/mpv-dev-x86_64-20260107-git-85bf9f4.7z
    curl -L --output "$ROOTDIR/vnd/" https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-07-85bf9f4/
...
prebuild() {
    ...
    if [ ! -f $ROOTDIR/vnd/mpv-dev-x86_64-20260107-git-85bf9f4.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-x86_64-20260107-git-85bf9f4.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-07-85bf9f4/mpv-dev-x86_64-20260107-git-85bf9f4.7z
        checkvendorerror $?
    fi
    ...
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-x86_64-20260107-git-85bf9f4.7z libmpv-2.dll && cd -
    checkvendorerror $?
