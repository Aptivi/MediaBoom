...
localize() {
    ...
    curl -L --output "$ROOTDIR/vnd/mpv-dev-x86_64-20251228-git-4ecf729.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2025-12-28-4ecf729/mpv-dev-x86_64-20251228-git-4ecf729.7z
    curl -L --output "$ROOTDIR/vnd/mpv-dev-aarch64-20251228-git-4ecf729.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2025-12-28-4ecf729/mpv-dev-aarch64-20251228-git-4ecf729.7z
...
prebuild() {
    ...
    if [ ! -f $ROOTDIR/vnd/mpv-dev-x86_64-20251228-git-4ecf729.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-x86_64-20251228-git-4ecf729.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2025-12-28-4ecf729/mpv-dev-x86_64-20251228-git-4ecf729.7z
        checkvendorerror $?
    fi
    if [ ! -f $ROOTDIR/vnd/mpv-dev-aarch64-20251228-git-4ecf729.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-aarch64-20251228-git-4ecf729.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2025-12-28-4ecf729/mpv-dev-aarch64-20251228-git-4ecf729.7z
        checkvendorerror $?
    fi

    # Install the DLL for AMD64
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-x86_64-20251228-git-4ecf729.7z libmpv-2.dll && cd -
    checkvendorerror $?
    ...
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-aarch64-20251228-git-4ecf729.7z libmpv-2.dll && cd -
    checkvendorerror $?
