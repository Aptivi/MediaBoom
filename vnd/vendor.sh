...
localize() {
    ...
    curl -L --output "$ROOTDIR/vnd/mpv-dev-x86_64-20250926-git-74b47cf.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2025-09-26-74b47cf/mpv-dev-x86_64-20250926-git-74b47cf.7z
    curl -L --output "$ROOTDIR/vnd/mpv-dev-aarch64-20250926-git-74b47cf.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2025-09-26-74b47cf/mpv-dev-aarch64-20250926-git-74b47cf.7z
...
prebuild() {
    ...
    if [ ! -f $ROOTDIR/vnd/mpv-dev-x86_64-20250926-git-74b47cf.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-x86_64-20250926-git-74b47cf.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2025-09-26-74b47cf/mpv-dev-x86_64-20250926-git-74b47cf.7z
        checkvendorerror $?
    fi
    if [ ! -f $ROOTDIR/vnd/mpv-dev-aarch64-20250926-git-74b47cf.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-aarch64-20250926-git-74b47cf.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2025-09-26-74b47cf/mpv-dev-aarch64-20250926-git-74b47cf.7z
        checkvendorerror $?
    fi

    # Install the DLL for AMD64
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-x86_64-20250926-git-74b47cf.7z libmpv-2.dll && cd -
    checkvendorerror $?
    ...
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-aarch64-20250926-git-74b47cf.7z libmpv-2.dll && cd -
    checkvendorerror $?
