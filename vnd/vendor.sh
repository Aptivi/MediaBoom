...
localize() {
    ...
    curl -L --output "$ROOTDIR/vnd/mpv-dev-x86_64-20251229-git-468e2a8.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2025-12-29-468e2a8/mpv-dev-x86_64-20251229-git-468e2a8.7z
    curl -L --output "$ROOTDIR/vnd/mpv-dev-aarch64-20251229-git-468e2a8.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2025-12-29-468e2a8/mpv-dev-aarch64-20251229-git-468e2a8.7z
...
prebuild() {
    ...
    if [ ! -f $ROOTDIR/vnd/mpv-dev-x86_64-20251229-git-468e2a8.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-x86_64-20251229-git-468e2a8.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2025-12-29-468e2a8/mpv-dev-x86_64-20251229-git-468e2a8.7z
        checkvendorerror $?
    fi
    if [ ! -f $ROOTDIR/vnd/mpv-dev-aarch64-20251229-git-468e2a8.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-aarch64-20251229-git-468e2a8.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2025-12-29-468e2a8/mpv-dev-aarch64-20251229-git-468e2a8.7z
        checkvendorerror $?
    fi

    # Install the DLL for AMD64
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-x86_64-20251229-git-468e2a8.7z libmpv-2.dll && cd -
    checkvendorerror $?
    ...
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-aarch64-20251229-git-468e2a8.7z libmpv-2.dll && cd -
    checkvendorerror $?
