...
localize() {
    ...
    curl -L --output "$ROOTDIR/vnd/mpv-dev-x86_64-20260103-git-a3350e2.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-03-a3350e2/mpv-dev-x86_64-20260103-git-a3350e2.7z
    curl -L --output "$ROOTDIR/vnd/" https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-03-a3350e2/
...
prebuild() {
    ...
    if [ ! -f $ROOTDIR/vnd/mpv-dev-x86_64-20260103-git-a3350e2.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-x86_64-20260103-git-a3350e2.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-03-a3350e2/mpv-dev-x86_64-20260103-git-a3350e2.7z
        checkvendorerror $?
    fi
    ...
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-x86_64-20260103-git-a3350e2.7z libmpv-2.dll && cd -
    checkvendorerror $?
