...
localize() {
    ...
    curl -L --output "$ROOTDIR/vnd/mpv-dev-x86_64-20260106-git-c63fe8a.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-06-c63fe8a/mpv-dev-x86_64-20260106-git-c63fe8a.7z
    curl -L --output "$ROOTDIR/vnd/" https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-06-c63fe8a/
...
prebuild() {
    ...
    if [ ! -f $ROOTDIR/vnd/mpv-dev-x86_64-20260106-git-c63fe8a.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-x86_64-20260106-git-c63fe8a.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-06-c63fe8a/mpv-dev-x86_64-20260106-git-c63fe8a.7z
        checkvendorerror $?
    fi
    ...
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-x86_64-20260106-git-c63fe8a.7z libmpv-2.dll && cd -
    checkvendorerror $?
