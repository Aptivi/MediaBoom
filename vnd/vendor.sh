...
localize() {
    ...
    curl -L --output "$ROOTDIR/vnd/mpv-dev-x86_64-20260125-git-e99a916.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-25-e99a916/mpv-dev-x86_64-20260125-git-e99a916.7z
    curl -L --output "$ROOTDIR/vnd/mpv-dev-aarch64-20260125-git-e99a916.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-25-e99a916/mpv-dev-aarch64-20260125-git-e99a916.7z
...
prebuild() {
    ...
    if [ ! -f $ROOTDIR/vnd/mpv-dev-x86_64-20260125-git-e99a916.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-x86_64-20260125-git-e99a916.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-25-e99a916/mpv-dev-x86_64-20260125-git-e99a916.7z
        checkvendorerror $?
    fi
    if [ ! -f $ROOTDIR/vnd/mpv-dev-aarch64-20260125-git-e99a916.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-aarch64-20260125-git-e99a916.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-25-e99a916/mpv-dev-aarch64-20260125-git-e99a916.7z
        checkvendorerror $?
    fi

    # Install the DLL for AMD64
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-x86_64-20260125-git-e99a916.7z libmpv-2.dll && cd -
    checkvendorerror $?
    ...
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-aarch64-20260125-git-e99a916.7z libmpv-2.dll && cd -
    checkvendorerror $?
