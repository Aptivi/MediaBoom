...
localize() {
    ...
    curl -L --output "$ROOTDIR/vnd/mpv-dev-x86_64-20260121-git-313beaf.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-21-313beaf/mpv-dev-x86_64-20260121-git-313beaf.7z
    curl -L --output "$ROOTDIR/vnd/mpv-dev-aarch64-20260121-git-313beaf.7z" https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-21-313beaf/mpv-dev-aarch64-20260121-git-313beaf.7z
...
prebuild() {
    ...
    if [ ! -f $ROOTDIR/vnd/mpv-dev-x86_64-20260121-git-313beaf.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-x86_64-20260121-git-313beaf.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-21-313beaf/mpv-dev-x86_64-20260121-git-313beaf.7z
        checkvendorerror $?
    fi
    if [ ! -f $ROOTDIR/vnd/mpv-dev-aarch64-20260121-git-313beaf.7z ]; then
        curl -L --output $ROOTDIR/vnd/mpv-dev-aarch64-20260121-git-313beaf.7z https://github.com/zhongfly/mpv-winbuild/releases/download/2026-01-21-313beaf/mpv-dev-aarch64-20260121-git-313beaf.7z
        checkvendorerror $?
    fi

    # Install the DLL for AMD64
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-x86_64-20260121-git-313beaf.7z libmpv-2.dll && cd -
    checkvendorerror $?
    ...
    cd $ROOTDIR/vnd && "$sevenzpath" x $ROOTDIR/vnd/mpv-dev-aarch64-20260121-git-313beaf.7z libmpv-2.dll && cd -
    checkvendorerror $?
