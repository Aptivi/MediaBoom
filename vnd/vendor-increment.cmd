...
set "releaseFiles="%ROOTDIR%\PKGBUILD-REL" "%ROOTDIR%\.github\workflows\build-ppa-package-with-lintian.yml" "%ROOTDIR%\.github\workflows\build-ppa-package.yml" "%ROOTDIR%\.github\workflows\pushamend.yml" "%ROOTDIR%\.github\workflows\pushppa.yml" "%ROOTDIR%\.gitlab\workflows\release.yml" "%ROOTDIR%\public\MediaBoom.Installers\MediaBoom.Installer\Package.wxs" "%ROOTDIR%\public\MediaBoom.Installers\MediaBoom.InstallerBundle\Bundle.wxs" "%ROOTDIR%\Directory.Build.props" "%ROOTDIR%\CHANGES.TITLE""
...
powershell -Command "& '%ROOTDIR%\vnd\eng\mb-version-change.ps1' '%ROOTDIR%' '%oldApiVer%' '%newApiVer%'"
