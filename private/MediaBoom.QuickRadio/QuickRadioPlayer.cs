...
using MediaBoom.QuickRadio.Arguments;
using MediaBoom.QuickRadio.Languages;
...
namespace MediaBoom.QuickRadio
{
    internal class QuickRadioPlayer
    {
        ...
        static int Main(string[] args)
        {
            ...
            {
                TextWriterColor.Write(LanguageTools.GetLocalized("MEDIABOOM_QUICKRADIO_NOTSPECIFIED"), ThemeColorType.Error);
                return 1;
            }
            if (!quiet)
                TextWriterColor.Write(LanguageTools.GetLocalized("MEDIABOOM_QUICKRADIO_OPENING"), ThemeColorType.Progress, radioPath);
            ...
            if (!quiet)
            {
                ...
                TextWriterColor.Write(LanguageTools.GetLocalized("MEDIABOOM_QUICKRADIO_EXITTIP") + "\n", ThemeColorType.Tip);
            }
            ...
            {
                TextWriterColor.Write(LanguageTools.GetLocalized("MEDIABOOM_QUICKRADIO_FAILURE") + $": {ex.Message}", ThemeColorType.Error);
            }
