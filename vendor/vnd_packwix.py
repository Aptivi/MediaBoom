...
def vnd_action(args):
    ...
    # Copy the exe file
    source_installer_file = solution + f'/public/MediaBoom.Installers/MediaBoom.InstallerBundle/bin/{architecture}/{release}/MediaBoom.InstallerBundle.exe'
    target_installer_file = solution + f'/artifacts/mediaboom-win-{architecture.lower()}-installer.exe'
